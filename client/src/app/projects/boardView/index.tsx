    ...
    return (
        ...
        >
            <div className="mb-3 flex w-full">
                ...
                />
                <div className="flex w-full bg-zinc-200 items-center justify-between rounded-e-lg px-5 py-4 dark:bg-dark-secondary">
...
const Task = ({ task }: TaskProps) => {
    ...
    return (
        <div
            ...
            className={`mb-4 rounded-md bg-zinc-200 shadow-xl dark:bg-dark-secondary ${isDragging ? "opacity-50" : "opacity-100"
                }`}
        >
            ...
            <div className="p-4 md:p-6">
                ...
                <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center text-gray-500 dark:text-neutral-500">
                        <button onClick={() => handleShowComments()} className="cursor-pointer">
                            {showComments ? (
                ...
                {showComments && (
                    <div className="mt-4 border-t border-gray-200 dark:border-stroke-dark">
                        {task.comments?.map((comment) => (
                            <div key={comment.id} className="py-6 my-4 bg-slate-400 rounded-xl text-white justify-center items-center flex">
                                {comment.userId && task.author && (
